...
function results = run_IBRI(seq, res_path, bSaveImage)%                     加了正则项的IBRI
...
params.learning_rate_1 = 0.0131;
params.learning_rate_2 = 0.019;

gamma = 0.443;%frame weight base
params.admm_gamma(1) = 0;
params.F = 3;%historical interval length
for m = 1:params.F
...
% Initialize
params.seq = seq;
params.penaltyfa = 2.94;%bucketing penalty factor
params.bucket = 1;%bucketing scheme on/off
params.thr = 0.47;%threshold to judge disruptors
params.spatial = 11;%bucketing number
% Run tracker
