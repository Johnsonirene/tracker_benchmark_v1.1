function results = run_DSHCF_fb(seq, rp, bSaveImage)
...
% TB-BiCF parameters
params.learning_rate = 0.04;  % TB-BiCF online adaption rate 
params.t_lambda = 1.2;           % Regularization factor on TB-BiCF
params.t_lambda2 = 0.001;
params.gamma = 0.15;            % Regularization factor on bidirectional error
params.frame_interval = 3;     % Maximum frame interval within the temporary block
